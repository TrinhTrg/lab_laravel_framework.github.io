<div class="fixed z-50 rounded-lg" style="right: 20px; top: 20px;">
    <div x-data="{
        ...
        <button x-ref="button"
                ...
                type="button"
                class="flex flex-row text-on-surface-600 active:translate-y-1 items-center">
            @auth
        ...
        <div x-ref="panel"
             ...
             style="display: none;"
             class="absolute right-0 top-10 rounded-lg bg-surface shadow-xl w-64 shadow-lg p-4">
            ...
            :class="[
                'cursor-pointer flex items-center gap-1 w-full rounded px-6 py-2 text-left text-base transition-colors duration-200',
                selectedTheme === 'theme-light'
                    ? 'bg-primary-600 text-on-primary-50'
                    : 'bg-surface text-on-surface-500 hover:bg-primary-600 hover:text-on-primary-50'
            ]">
            <svg xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
